const FOLLOWUP_TEMPLATES = [
  {
    ...
    stages: ["3h"],
    statuses: ["price_requested", "later_followup"],
  ...
  },
  {
    ...
    stages: ["24h"],
    statuses: ["quote_sent_no_reply", "high_intent_no_reply", "price_requested"],
  ...
  },
  {
    ...
    stages: ["48h"],
    statuses: ["quote_sent_no_reply", "payment_interest_no_reply", "shipping_question_no_reply", "price_requested"],
  ...
  },
  {
    ...
    stages: ["72h"],
    statuses: ["quote_sent_no_reply", "payment_interest_no_reply", "shipping_question_no_reply", "later_followup", "price_requested"],
  ...
  },
  {
    ...
    stages: ["6h", "9h", "24h", "48h"],
    statuses: ["shipping_question_no_reply", "quote_sent_no_reply"],
  ...
  },
  {
    ...
    stages: ["72h"],
    statuses: ["price_requested", "quote_sent_no_reply", "payment_interest_no_reply", "shipping_question_no_reply", "later_followup"],
